...
function getSuggestionComponent() {
  const { config } = this;
  return class SuggestionComponent extends React.Component<ISuggestionComponentProps, ISuggestionState> {
    suggestion: any;
    dropdown: any;
    ...
    componentDidMount() {
      ...
      this.setState({ 
        style: { left:15, right: 15, bottom:0 },
      });
    ...
    onEditorKeyDown = (event) => {
      ...
      const newState:ISuggestionState = {};
